...
export const cmtraceFluentTheme: Theme = {
  ...webLightTheme,
    ...
    "fontFamilyBase": "var(--cmtrace-font-family-ui, 'Segoe UI', 'Segoe UI Web (West European)', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', sans-serif)",
    "fontFamilyMonospace": "var(--cmtrace-font-family-mono, Consolas, 'Courier New', Courier, monospace)",
    "fontFamilyNumeric": "var(--cmtrace-font-family-ui, Bahnschrift, 'Segoe UI', 'Segoe UI Web (West European)', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica Neue', sans-serif)",
