...
- **Removed an unused timeline hook**: `useTimelineBundle` had no consumers - the modules that import that file all use the exported `buildTimelineFromSources` instead. The hook is gone and the module is renamed to match what it exports.
