...
2. Run `scripts/review_state.py` from the skill directory. Record `head_sha`, `coderabbit_review_count`, `latest_coderabbit_review_state`, `approved_at_head`, and the unresolved CodeRabbit thread IDs.
