...
Import-CollectorFunctions -ScriptPath $collectorScriptPath -FunctionNames @(
...
try {
    ...
    $aliceLogDir = '{0}:\Users\Alice\AppData\Local\Packages\MSTeams_8wekyb3d8bbwe\LocalCache\Microsoft\MSTeams\Logs' -f $driveName
    $bobLogDir = '{0}:\Users\Bob\AppData\Local\Packages\MSTeams_8wekyb3d8bbwe\LocalCache\Microsoft\MSTeams\Logs' -f $driveName
    ...
    $expandedMatches = @(Get-ResolvedLogMatches -SourcePattern '%LOCALAPPDATA%\Packages\MSTeams_8wekyb3d8bbwe\LocalCache\Microsoft\MSTeams\Logs\*')
    ...
    $allUserMatches = @(Get-ResolvedLogMatches -SourcePattern ('{0}:\Users\*\AppData\Local\Packages\MSTeams_8wekyb3d8bbwe\LocalCache\Microsoft\MSTeams\Logs\*' -f $driveName))
