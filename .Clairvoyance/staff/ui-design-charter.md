...
- Prepare approved file edits and proposed browser checks only. Main independently inspects the changes, runs browser/other verification, and owns every command and Git/GitHub operation.
