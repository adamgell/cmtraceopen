...
import espDiagnosticsFixture from "./demo/esp-diagnostics.json" with { type: "json" };
...
export const MOCK_ESP_DIAGNOSTICS = {
  baseSnapshot:
    espDiagnosticsFixture.baseSnapshot as unknown as EspDiagnosticsSnapshot,
  fullGraph: espDiagnosticsFixture.graph.full as unknown as EspGraphOverlay,
  variants: espDiagnosticsFixture.variants,
};
...
const LOG_SEEDS: LogSeed[] = [
  {
    message:
      'Performing detection of app deployment type "Contoso VPN Client 4.2 (x64)" for system.',
    severity: "Info",
    component: "AppDiscovery",
  },
  {
    message:
      "+++ Application not discovered. [AppDT Id: ScopeId_A1/DeploymentType_9f3, Revision: 3]",
    severity: "Info",
    component: "AppDiscovery",
  },
  {
    message: 'The user clicked to install "Contoso VPN Client 4.2 (x64)".',
    severity: "Info",
    component: "AppEnforce",
  },
  {
    message:
      'Executing Command line: "C:\\WINDOWS\\system32\\msiexec.exe" /i "ContosoVPN.msi" /q /l*v "C:\\WINDOWS\\ccm\\logs\\ContosoVPN_install.log"',
    severity: "Info",
    component: "AppEnforce",
  },
  {
    message:
      "Existing anti-malware scan already in progress, deferring content download by 30 seconds.",
    severity: "Warning",
    component: "AppEnforce",
  },
  {
    message: "Process 6132 terminated with exitcode: 1603",
    severity: "Error",
    component: "AppEnforce",
  },
  {
    message: "Matched exit code 1603 to a Failure entry in exit codes table.",
    severity: "Info",
    component: "AppEnforce",
  },
  {
    message:
      "CMsiHandler::EnforceApp failed with error 0x80070643 (The installation package could not be opened).",
    severity: "Error",
    component: "AppEnforce",
    errorCode: {
      hex: "0x80070643",
  ...
  {
    message:
      "Method CBaseProvider::EnforceApp failed with error code 0x87D00269",
    severity: "Error",
    component: "AppEnforce",
    errorCode: {
      hex: "0x87D00269",
      decimal: "-2016410007",
      description: "Application requirement evaluation or detection failed.",
      category: "ConfigMgr",
    },
  },
  {
    message: "Retrying install after 10 minute back-off. Attempt 2 of 3.",
    severity: "Warning",
    component: "AppEnforce",
  },
  {
  ...
  {
    message: "Process 8044 terminated with exitcode: 0",
    severity: "Info",
    component: "AppEnforce",
  },
  {
    message: "Matched exit code 0 to a Success entry in exit codes table.",
    severity: "Info",
    component: "AppEnforce",
  },
  {
    message:
      "+++ Discovered application [AppDT Id: ScopeId_A1/DeploymentType_9f3, Revision: 3]",
    severity: "Info",
    component: "AppEnforce",
  },
  {
    message:
      '++++++ App enforcement completed (successfully) for App DT "Contoso VPN Client 4.2 (x64)" ++++++',
    severity: "Success",
    component: "AppEnforce",
  },
];
...
export const MOCK_INTUNE = {
  ...
  events: [
    {
      ...
      eventType: "Win32App",
      name: "Company Portal",
      guid: "3f2b1a90-1111-4a2b-9c3d-aaaaaaaaaaaa",
      status: "Success",
      startTime: "2026-07-13 09:15:22.101",
      endTime: "2026-07-13 09:16:04.550",
      durationSecs: 42,
      errorCode: null,
      detail: "Install succeeded (exit code 0).",
    ...
    },
    {
      ...
      guid: "7a1c2b90-2222-4b3c-8d4e-bbbbbbbbbbbb",
      status: "Failed",
      startTime: "2026-07-13 09:22:10.300",
      endTime: "2026-07-13 09:22:59.900",
      durationSecs: 49,
      errorCode: "0x87D1041C",
      detail: "Detection rule failed after install; app not detected.",
      sourceFile: "AppWorkload.log",
      lineNumber: 1044,
      startTimeEpoch: null,
      endTimeEpoch: null,
    },
    {
      ...
      name: "Detect-DiskSpace.ps1",
      guid: null,
      status: "Failed",
      startTime: "2026-07-13 09:31:05.000",
      endTime: "2026-07-13 09:31:06.240",
      durationSecs: 1,
      errorCode: "0x80070005",
      detail: "Access is denied while writing remediation state.",
      sourceFile: "AgentExecutor.log",
      lineNumber: 205,
      startTimeEpoch: null,
      endTimeEpoch: null,
    },
    {
      ...
      guid: "c0ffee90-3333-4c4d-9e5f-cccccccccccc",
      status: "Success",
      startTime: "2026-07-13 09:40:00.000",
      endTime: "2026-07-13 09:41:12.000",
      durationSecs: 72,
      errorCode: null,
      detail: "Downloaded 512.0 MB via Delivery Optimization (peer: 38%).",
    ...
    },
    {
      ...
      guid: "c0ffee90-3333-4c4d-9e5f-cccccccccccc",
      status: "Success",
      startTime: "2026-07-13 09:41:20.000",
      endTime: "2026-07-13 09:43:02.000",
      durationSecs: 102,
      errorCode: null,
      detail: "Install succeeded (exit code 0).",
      sourceFile: "AppWorkload.log",
    ...
    },
    {
      ...
      guid: null,
      status: "Success",
      startTime: "2026-07-13 09:46:33.000",
      endTime: "2026-07-13 09:47:10.000",
      durationSecs: 37,
      errorCode: null,
      detail: "All 14 settings evaluated compliant.",
      sourceFile: "IntuneManagementExtension.log",
      lineNumber: 1702,
      startTimeEpoch: null,
      endTimeEpoch: null,
  ...
  downloads: [
    {
      ...
      durationSecs: 72,
      success: true,
      timestamp: "2026-07-13 09:41:12.000",
      timestampEpoch: null,
    },
    {
      contentId: "app-company-portal",
      name: "Company Portal",
      sizeBytes: 78643200,
      speedBps: 12582912,
      doPercentage: 61,
      durationSecs: 6,
      success: true,
      timestamp: "2026-07-13 09:15:19.000",
      timestampEpoch: null,
    },
    {
      contentId: "app-7zip-2301",
      name: "7-Zip 23.01 (x64)",
      sizeBytes: 1887436,
      speedBps: 0,
      doPercentage: 0,
      durationSecs: 5,
      success: false,
      timestamp: "2026-07-13 09:22:15.000",
      timestampEpoch: null,
    },
  ],
  summary: {
  ...
  diagnostics: [
    {
      id: "diag-win32-detect-fail",
      severity: "Error",
      category: "Install",
      remediationPriority: "High",
      title: "Win32 app installed but failed detection",
      summary:
        "7-Zip 23.01 exited 0 but the detection rule did not match, so Intune reports the install as failed.",
      likelyCause:
        "The detection rule points at a version or path that the installer does not produce.",
      evidence: ["AppWorkload.log:1044 - detection failed (0x87D1041C)"],
      nextChecks: [
        "Confirm the detection rule file/version",
        "Re-run detection manually on the device",
      ],
      suggestedFixes: [
        "Update the detection rule to match the installed build",
      ],
      focusAreas: ["Detection"],
      affectedSourceFiles: ["AppWorkload.log"],
      relatedErrorCodes: ["0x87D1041C"],
    },
    {
      id: "diag-script-access-denied",
      severity: "Warning",
      category: "Script",
      remediationPriority: "Medium",
      title: "Remediation script blocked by permissions",
      summary:
        "Detect-DiskSpace.ps1 failed with Access Denied while writing its state file.",
      likelyCause:
        "The script runs in the user context but writes to a protected location.",
      ...
      focusAreas: ["Permissions"],
      affectedSourceFiles: ["AgentExecutor.log"],
      relatedErrorCodes: ["0x80070005"],
    },
  ],
};
...
const DSREGCMD_RESULT = {
  facts: {
    ...
    deviceDetails: {
      ...
      deviceCertificateValidity:
        "[ 2025-01-10 09:14:02.000 UTC -- 2035-01-08 09:14:02.000 UTC ]",
    ...
    managementDetails: {
      ...
      deviceManagementSrvId: "0000000a-0000-0000-c000-000000000000",
    },
    serviceEndpoints: {
    ...
    userState: {
      ngcSet: true,
      ngcKeyId: "c3d4e5f6-1234-4a5b-8c9d-0e1f2a3b4c5d",
      canReset: "DestructiveOnly",
      wamDefaultSet: true,
      wamDefaultAuthority: "organizations",
      wamDefaultId: "https://login.microsoft.com",
      wamDefaultGuid: "9a8b7c6d-5e4f-3a2b-1c0d-9e8f7a6b5c4d",
      isDeviceJoined: true,
      isUserAzureAd: true,
      policyEnabled: true,
      postLogonEnabled: true,
      deviceEligible: true,
      sessionIsNotRemote: true,
    },
    ssoState: {
      azureAdPrt: true,
      azureAdPrtAuthority:
        "https://login.microsoftonline.com/9a8b7c6d-5e4f-3a2b-1c0d-9e8f7a6b5c4d",
      azureAdPrtUpdateTime: "2026-07-13 06:02:11.000 UTC",
      ...
      onPremTgt: false,
      cloudTgt: true,
      adfsRefreshToken: false,
      adfsRaIsReady: false,
      kerbTopLevelNames: ".contoso.com,.windows.net",
    },
    diagnostics: {
      previousPrtAttempt: "2026-07-13 06:02:11.000 UTC",
      attemptStatus: "0x0",
      userIdentity: "alice@contoso.com",
      credentialType: "Password",
      correlationId: "7f3a1b2c-8d9e-4f01-a2b3-c4d5e6f70819",
      endpointUri: "https://login.microsoftonline.com/common/oauth2/token",
      httpMethod: "POST",
      httpError: null,
      httpStatus: 200,
      requestId: "b1c2d3e4-f5a6-7890-1234-56789abcdef0",
      diagnosticsReference: null,
      userContext: null,
      clientTime: "2026-07-13 06:02:10.000 UTC",
    },
    preJoinTests: {
      adConnectivityTest: null,
      adConfigurationTest: null,
      drsDiscoveryTest: "SUCCESS",
      drsConnectivityTest: "SUCCESS",
      tokenAcquisitionTest: "SUCCESS",
    ...
    registration: {
      ...
      errorPhase: null,
      certEnrollment: "none",
      logonCertTemplateReady: "NotApplicable",
      preReqResult: "Will Provision",
      clientErrorCode: "0x0",
  ...
  derived: {
    ...
    joinTypeLabel: "Microsoft Entra joined",
    dominantPhase: "post_join",
    phaseSummary:
    ...
    stalePrt: false,
    prtLastUpdate: "2026-07-13 06:02:11.000 UTC",
    prtReferenceTime: "2026-07-13 08:40:00.000 UTC",
    prtAgeHours: 2.6,
    tpmProtected: true,
    certificateValidFrom: "2025-01-10 09:14:02.000 UTC",
    certificateValidTo: "2035-01-08 09:14:02.000 UTC",
    certificateExpiringSoon: false,
    certificateDaysRemaining: 3101,
  ...
  diagnostics: [
    ...
    },
    {
      ...
      summary:
        "OnPremTgt and EnterprisePrt are not set. Expected for a cloud-only Entra joined device without Hybrid configuration.",
      evidence: ["EnterprisePrt : NO", "OnPremTgt : NO"],
      nextChecks: [
        "Confirm whether on-prem resource access is required for this user",
      ],
      suggestedFixes: [
        "If on-prem SSO is needed, configure Entra Connect / Cloud Kerberos Trust",
      ],
    },
  ],
  policyEvidence: {
