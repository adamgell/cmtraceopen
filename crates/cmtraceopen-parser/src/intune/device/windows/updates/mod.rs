...
pub use sources::{
    ...
    SupplementalReading, MDM_DIAGNOSTICS_PROVIDER, NAMED_ADAPTER_OUTCOME, NAMED_ADAPTER_PHASE,
    NAMED_DEFERRAL_REASON, NAMED_ERROR_CODE, NAMED_KB_ARTICLE_IDS, NAMED_NODE_URI,
    NAMED_SERVICE_GUID, NAMED_UNSUPPORTED_VALUE, NAMED_UPDATE_COUNT, NAMED_UPDATE_GUID,
    NAMED_UPDATE_REVISION, NAMED_UPDATE_TITLE, NAMED_WINNING_POLICY_ID, POLICY_MANAGER_UPDATE_KEY,
